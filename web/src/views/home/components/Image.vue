  ...
  <article class="thumb img-area">
    <a class="thumb-a my-photo" :data-src="data.detail">
      <img
        ...
        onerror="this.src=`/images/loading.gif`;this.onerror=null"
        :src="data.thumbnail"
        lazy
      />
    </a>
    ...
    <ul class="tags">
      <li class="tag-meta">
        <router-link
          ...
          class="tag-location tag-thumbnail-location"
          :to="'/location/' + data.location"
          >{{ data.location }}</router-link
        >
        <router-link
          v-if="detail_show_location && data.location"
          class="tag-location tag-detail-location"
          :to="'/location/' + data.location"
          >{{ data.location }}</router-link
        >
        <a v-if="thumbnail_show_time && data.time" class="tag-time tag-thumbnail-time">{{
          thumbnail_time
        }}</a>
        <a v-if="detail_show_time && data.time" class="tag-time tag-detail-time">{{
          detail_time
        }}</a>
      </li>
      <li class="tag-categories">
        <router-link
          v-for="category in data.formatted_categories"
          :key="category.alias"
