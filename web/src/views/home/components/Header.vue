<template>
  <header id="header">
    ...
    <router-link :to="'/'"
      ><strong style="margin-left: 8px">{{ site_name }}</strong></router-link
    >
    ...
    <nav>
      <ul>
              ...
              <li v-for="category in categories" class="category-level-0 category-parent">
                ...
                <ul>
                  <li
                    ...
                    class="category-level-1 category-child category-level-odd"
                  >
                    <router-link :to="'/category/' + child.alias">{{ child.name }}</router-link>
                  </li>
                </ul>
              </li>
            </ul>
        ...
        <li><a id="header-about" style="cursor: pointer" @click="togglePanel">关于</a></li>
      </ul>
    </nav>
  </header>
</template>
